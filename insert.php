...
if(isset($_POST['new']) && $_POST['new']==1){
    ...
    (`trn_date`,`name`,`quantity`,`price`,`submittedby`)values
    ('$trn_date','$name','$quantity','$price','$submittedby')";
...
<p><input type="text" name="quantity" placeholder="Number of products " required /></p>
